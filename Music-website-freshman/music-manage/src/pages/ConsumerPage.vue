<template>
  <div class="table">
    ...
    <el-table size="mini" ref ="multipleTable" border style="width: 100%" height="780px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户名称" prop="username" width="120" align="center"></el-table-column>
      ...
      <el-table-column label="邮箱" prop="email" width="240" align="center"></el-table-column>
    ...
    <el-dialog title="添加用户" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form :model="registerForm" ref="registerForm" label-width="80px" status-icon :rules="rules">
        ...
        <el-form-item prop="phoneNum" label="号码" size="mini">
          <el-input v-model="registerForm.phoneNum" placeholder="号码">
          </el-input>
        </el-form-item>
    ...
    <el-dialog title="修改用户" :visible.sync="editVisible" width="400px" center>
      <el-form :model="form" ref="form" label-width="80px" status-icon :rules="rules">
        ...
        <el-form-item prop="phoneNum" label="号码" size="mini">
          <el-input v-model="form.phoneNum" placeholder="号码">
          </el-input>
        </el-form-item>
        <el-form-item prop="email" label="邮箱" size="mini">
        ...
        <el-form-item prop="introduction" label="签名" size="mini">
          <el-input v-model="form.introduction" placeholder="签名">
          </el-input>
        </el-form-item>
        <el-form-item prop="location" label="地区" size="mini">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="editSave">确定</el-button>
      </span>
    </el-dialog>
...
<script>
import {setConsumer, getAllConsumer, updateConsumer, delConsumer} from '../api/index'
