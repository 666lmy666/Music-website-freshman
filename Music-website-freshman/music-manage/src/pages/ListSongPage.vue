<template>
  <div class="table">
    <div class="crumbs">
      <i class="el-icon-tickets">歌单的歌曲信息</i>
    </div>
    <div class="container">
    ...
    <el-table size="mini" ref ="multipleTable" border style="width: 100%" height="780px" :data="tableData" @selection-change="handleSelectionChange">
