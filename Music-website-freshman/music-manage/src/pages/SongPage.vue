<template>
  <div class="table">
    ...
    <el-table size="mini" ref ="multipleTable" border style="width: 100%" height="780px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="name" label="歌名" width="150" align="center"></el-table-column>
      <el-table-column prop="introduction" label="专辑" width="150" align="center">
        <template slot-scope="scope">
          <p style="height: 50px;overflow: scroll">{{scope.row.introduction}}</p>
        </template>
      </el-table-column>
    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form :model="registerForm" ref="registerForm" label-width="80px" action="" id="tf" status-icon>
          <div>
            <label>歌名</label>
    ...
    <el-dialog title="修改歌曲" :visible.sync="editVisible" width="600px" center>
      <el-form :model="form" ref="form" label-width="80px" status-icon>
        ...
        <el-form-item prop="introduction" label="专辑" size="mini">
          <el-input v-model="form.introduction" placeholder="专辑" type="textarea">
          </el-input>
        </el-form-item>
